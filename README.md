This is a Java program which finds the quickest delivery route of a Migros delivery car. In the map, there is a Migros store, denoted by the orange circle, and several houses, denoted by the gray circles.
